      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
          <div className="p-4 bg-card rounded-lg border-hsla">
            ...
            <p className="text-secondary-text text-sm">Built with the latest technologies and best practices</p>
          </div>
          <div className="p-4 bg-card rounded-lg border-hsla">
            <h3 className="font-body text-text font-bold mb-2">Case Studies</h3>
            <p className="text-secondary-text text-sm">Real-world projects and their success stories</p>
          </div>
          <div className="p-4 bg-card rounded-lg border-hsla">
            <h3 className="font-body text-text font-bold mb-2">Innovation Hub</h3>
            <p className="text-secondary-text text-sm">Explore our experimental and cutting-edge solutions</p>
          </div>
        </div>
      </div>
    </section>
